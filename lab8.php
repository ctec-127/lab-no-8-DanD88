...
<div id="wrapper" class="container mt-4">
		...
		<div class="jumbotron bg-info">
			...
			<p class="font-weight-bold">Use the converter to convert a temperature to any scale.</p>
			<p class="font-weight-bold"> Conversion formulas and information about temperature scales are below the converter.</p>
			<p class="font-weight-bold lead">Enjoy!</p>
		</div>
	
	<form class="bg-dark p-4 rounded" id="form" method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
		<div class="section form-group">
			<label class="col-form-label col-form-label-lg lead font-weight-bold text-light" for="temp">Temperature</label>
		...
		<div class="section form-group">
			<label for="convertedtemp" class="col-form-label col-form-label-lg font-weight-bold lead text-light">Converted Temperature</label>
	...
	<div class="container p-0 my-4">
		...
		<div class="row my-5">
			<div class="col-lg-6">
				<h2 class="font-weight-bold mb-3 p-3 bg-info text-center rounded">Temperature Conversions</h2>
				<hr>
				<h4 class="font-weight-bold mb-2">Celsius:</h4>
					<ul class="list-group list-group-flush">
                        <li class="list-group-item font-weight-bold lead font-weight-bold">Celsius to Fahrenheit:</li>
                        <li class="list-group-item">Formula: (0°C × 9/5) + 32 = 32°F</li>
                        <li class="list-group-item font-weight-bold lead">Celsius to Kelvin:</li>
                        <li class="list-group-item">Formula: °C + 273.15 = K</li>
					</ul>
					
					<h4 class=" font-weight-bold mt-4">Fahrenheit:</h4>
                <ul class="list-group list-group-flush">
                    <li class="list-group-item font-weight-bold lead">Fahrenheit to Celsius:</li>
                    <li class="list-group-item ">Formula: (°F − 32) × 5/9 = °C</li>
                    <li class="list-group-item font-weight-bold lead">Fahrenheit to Kelvin:</li>
                    <li class="list-group-item">Formula: (°F − 32) × 5/9 + 273.15 = K</li>
				</ul>
				
				<h4 class="font-weight-bold mt-4">Kelvin:</h4>
                <ul class="list-group list-group-flush">
                    <li class="list-group-item font-weight-bold lead">Kelvin to Celsius:</li>
                    <li class="list-group-item">Formula: K − 273.15 = °C</li>
                    <li class="list-group-item font-weight-bold lead">Kelvin to Fahrenheit:</li>
                    <li class="list-group-item">Formula: (K − 273.15) × 9/5 + 32 = °F</li>
                </ul>
			</div>
	
			<div class="col-lg-6">
				<h2 class="font-weight-bold bg-info text-center p-3 rounded">Temperature Scales</h2>
				<hr>
				...
				<hr>
				<h4 class="font-weight-bold">Fahrenheit:</h4>
			...
			<hr>
			<h4 class="font-weight-bold">Kelvin:</h4>
